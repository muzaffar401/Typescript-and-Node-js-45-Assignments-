...
let GuestList: string [] = ["Ali","Hunain","Shadab","Hassan","Wasim"] ;
...
while(GuestList.length > 2){
    ...
    console.log(`Sorry, ${removeGuest} You are not longer invited to dinner. `)
}
...
let GuestList1: string [] = ["Ali","Hunain","Shadab","Hassan","Wasim"] ;
